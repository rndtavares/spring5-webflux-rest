...
public class VendorControllerTest {
    ...
    public void testCreateVendor(){
        BDDMockito.given(vendorRepository.saveAll(any(Publisher.class)))
                .willReturn(Flux.just(Vendor.builder().firstName("Ronaldo")
                                                    .lastName("Silva").build()));

        Mono<Vendor> vendorToSaveMono = Mono.just(Vendor.builder().firstName("Ronaldo")
                                                                .lastName("Silva").build());
    ...
    public void testUpdate(){
        ...
        Mono<Vendor> vendorToUpdateMono = Mono.just(Vendor.builder().firstName("Ronaldo")
                                                                    .lastName("Silva").build());
